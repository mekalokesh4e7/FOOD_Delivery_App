 ...
 */
@WebServlet("/RestaurantRegistrationServlet")
public class RestaurantRegistrationServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int ResContactNum=Integer.parseInt(request.getParameter("ResContactNum"));
		int ResBankAccNum=Integer.parseInt(request.getParameter("ResBankAccNum"));
		String ResEmail=request.getParameter("ResEmail");
		String ResPassword=request.getParameter("ResPassword");
		float ResAvgRating= Float.parseFloat(request.getParameter("ResAvgRating"));
